		...
		<div class="login-main">
			...
			<div class="login-box">
				...
				<div class="login-form">
					<form  method="post" id ="login_from" action="tUser/login.action">
						<div class="login-form">
							<!--用隐藏域传参表示是管理员登录,还是普通用户登录,true表示管理员-->
							<input type="hidden" name="isAdmin" value="false"/>
							<div class="user-name">
								<label for="user"><i class="am-icon-user"></i></label> <input
									type="text" id="user" name="name" id="userName" value="${uname2}" placeholder="邮箱/手机/用户名">
							</div>
							<div class="user-pass">
								<label for="password"><i class="am-icon-lock"></i></label> <input
									type="password" name="password" id="password" value="${pwd2}" placeholder="请输入密码">
							</div>
						</div>
						<div class="am-cf">
